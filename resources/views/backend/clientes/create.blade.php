...
<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
	...
	{!! Form::open(['route'=>'backend.clientes.store', 'method'=>'POST']) !!}
		
		<div class="form-group">
			{!! Form::label('nombre', 'Nombre') !!}
			{!! Form::text('nombre', null, ['class'=>'form-control', 'placeholder'=>'Empresa' ,'required'] ) !!}
		</div>
		<div class="form-group">
			{!! Form::label('razon_social', 'Razón Social') !!}
			{!! Form::text('razon_social', null, ['class'=>'form-control', 'placeholder'=>'Empresa LTDA' ,'required'] ) !!}
		</div>
		
		<div class="form-group">
			{!! Form::label('giro', 'Giro') !!}
			{!! Form::text('giro', null, ['class'=>'form-control', 'placeholder'=>'Compra y venta' ,'required'] ) !!}
		</div>
